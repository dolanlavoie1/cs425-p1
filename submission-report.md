...
- Submission generated at 09/17/2026 at 23:56:56
...
- Name: Dolan Lavoie
- Email: dolanlavoie@u.boisestate.edu
- Class: CS425-001
...
This was a cool project to do because it was interesting to look directly at how a protocol works, and actually deal with sockets recieving and sending information. It was crazy to find out how simple this protocol is, and how easy it is to put in whatever information you want, even if most ISPs block port 25. The 3 layer split is there for testing purposes. If a function doesn't return anything, it is much harder to test than a function that has a return value. By making sure every function has a return value, we dont have to check for side effects that the function creates, and can just directly test what is returned. They also help because we can't have our tests actually send messages to the mail server, so we need to be able to test as much as possible without actually going onto the internet. 
...
Unexpected SMTP reply: 500 no
Unexpected SMTP reply: 500 no
Unexpected SMTP reply: tests/lab-test.c:252:test_pure_helpers:PASS
tests/lab-test.c:253:test_read_line_and_reply:PASS
tests/lab-test.c:254:test_read_errors:PASS
tests/lab-test.c:255:test_write_and_command_errors:PASS
tests/lab-test.c:256:test_session_success:PASS
tests/lab-test.c:257:test_session_wrong_statuses:PASS
tests/lab-test.c:258:test_session_hangup:PASS
tests/lab-test.c:259:test_socket_functions:PASS
tests/lab-test.c:260:test_socket_connect:PASS
tests/lab-test.c:261:test_close:PASS
...
## Scripts Files
Report generated on 09/17/2026 at 23:56:58
...
SHA-256 Hash of the report: 07da98fe45158dbe269e51103c4d51365e040db9e15fa0aa13069fdf461a66b0

Do not edit the generated report. Any changes will be reported as academic dishonesty

---
## GitHub Info
- GitHub repo name: dolanlavoie1/cs425-p1
- The repository visibility is public.
- The workflow was triggered by dolanlavoie1
